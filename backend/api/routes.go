	...
	register([]RouteGroup{
		...
		},
		{
			...
			Routes: []Route{
				...
				{Method: "GET", Pattern: "/admin/system-logs", Handler: h.SystemAuditHandler.SystemLogs},
				...
				{Method: "GET", Pattern: "/admin/source-diagnostics", Handler: h.DashboardHandler.SourceDiagnostics},
				{Method: "POST", Pattern: "/admin/source-diagnostics/probe", Handler: h.DashboardHandler.ProbeSource},
				{Method: "GET", Pattern: "/admin/sources/sg-ssc/backfill", Handler: h.DashboardHandler.SGSSCBackfillStatus},
				{Method: "POST", Pattern: "/admin/sources/sg-ssc/backfill", Handler: h.DashboardHandler.QueueSGSSCBackfill},
